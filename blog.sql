...
CREATE TABLE `comment_messagecomment` (
  ...
  CONSTRAINT `comment_messagecomment_author_id_0bb97e6c_fk_user_ouser_id` FOREIGN KEY (`author_id`) REFERENCES `user_ouser` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for user_verifyrecord
-- ----------------------------
